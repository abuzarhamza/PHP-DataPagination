<?
    class DataPageset {
        ...
        function entries_per_page($entries_per_page) {
            $this->entries_per_page = $entries_per_page
        }

        function current_page($current_page) {
            $this->current_page=$current_page;
        }

        function total_entries($total_entries) {
            $this->total_entries=$total_entries;
        }
        ...
        function current_page($current_page=1) {
            // $this->total_entries;
            // $this->entries_per_page;
            //  current_page
            return $this->first_page if (undef() || );
            return $this->first_page if ($this->current_page < $this->first_page);
            return $this->last_page if ($this->current_page > $this->last_page);
        ...
        function enteries_on_this_page() {
